...
@Unique('uq_product_marketplace_category', ['catalogProductId', 'marketplaceId'])
@Index('idx_product_marketplace_category_vertical', ['vertical', 'marketplaceId', 'categoryId'])
