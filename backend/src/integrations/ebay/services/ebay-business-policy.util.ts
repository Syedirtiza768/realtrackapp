...
export function paReturnPolicyBlockedMessage(params: {
  ...
  parts.push(
    'eBay requires returns accepted, 30+ days, and seller-paid return shipping for New and New Other Parts & Accessories listings.',
  );
...
/** Motors / automotive category scope where P&A return rules may apply. */
