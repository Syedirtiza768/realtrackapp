...
export class SchedulerService {
  ...
  async scheduleInventoryLowStockAlert(): Promise<void> {
    await this.leader.runIfLeader('inventory-low-stock-check', 14_000, async () => {
  ...
  async scheduleInventoryDuplicateScan(): Promise<void> {
    await this.leader.runIfLeader('inventory-duplicate-scan', 3600, async () => {
  ...
  async scheduleOrderImport(): Promise<void> {
    await this.leader.runIfLeader('order-import-from-channels', 840, async () => {
  ...
  async scheduleCompetitorPriceCollection(): Promise<void> {
    await this.leader.runIfLeader('pricing-collect-competitor', 14_000, async () => {
  ...
  async scheduleSellerpunditPolicySync(): Promise<void> {
    await this.leader.runIfLeader('sellerpundit-policy-sync', 28_000, async () => {
