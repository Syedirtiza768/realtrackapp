...
@Module({
  imports: [
    TypeOrmModule.forFeature([
      InventoryLedger, InventoryEvent, StoreInventoryAllocation,
      ListingRecord, PartFitment, PipelineJob, ImageAsset,
      CatalogProduct, Store, ConnectedEbayAccount,
      EbayAccountMarketplace, EbayBusinessPolicy,
      EbayListingChannel, ListingStoreOverride,
    ]),
  ...
  providers: [
    InventoryService, InventoryWorkbenchService,
    InventoryAutoTriggerService, InventoryEditorService,
