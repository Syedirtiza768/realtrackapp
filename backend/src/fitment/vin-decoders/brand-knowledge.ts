...
L = GAC Toyota, Guangzhou, China`,
    ...
    partNumberFormat:
      'Toyota OEM format: XXXXX-XXXXX (5 digits, dash, 4-5 digits). Example: 04465-F4021 (front brake pads)',
    partNumberExamples: [
...
P = Araquari, Brazil`,
    partNumberFormat:
      'BMW OEM format: XX XX X XXX XXX (space-separated groups, or continuous 11 digits). Example: 34 11 6 796 827',
    partNumberExamples: [
...
W = Wayne, Michigan`,
    partNumberFormat:
      'Ford OEM format: XXXX-XXXXX-X (4 digits, dash, 5 digits, dash, letter suffix). Example: BR3Z-1006-A',
    partNumberExamples: [
...
U = Detroit, Michigan (Hamtramck)`,
    partNumberFormat:
      'GM OEM format: XXXXXXXX (8 digits, no separator). Example: 84127658',
    partNumberExamples: [
