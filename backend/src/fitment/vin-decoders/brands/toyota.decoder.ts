...
export class ToyotaVinDecoder implements BrandVinDecoder {
  ...
  decodePlant(code: string): DecodedPlant | null {
    const plants: Record<string, DecodedPlant> = {
      // Japan plants
      '0': {
        plantName: 'Toyota Motor Corporation - Tahara Plant',
        city: 'Tahara',
        state: 'Aichi',
        country: 'Japan',
      },
      '1': {
        plantName: 'Toyota Motor Corporation - Motomachi Plant',
        city: 'Toyota City',
        state: 'Aichi',
        country: 'Japan',
      },
      '2': {
        plantName: 'Toyota Motor Corporation - Tsutsumi Plant',
        city: 'Toyota City',
        state: 'Aichi',
        country: 'Japan',
      },
      ...
      '4': {
        plantName: 'Toyota Motor Corporation - Miyata Plant',
        city: 'Miyawaka',
        state: 'Fukuoka',
        country: 'Japan',
      },
      '5': {
        plantName: 'Toyota Motor Corporation - Myochi Plant',
        city: 'Toyota City',
        state: 'Aichi',
        country: 'Japan',
      },
      '6': {
        plantName: 'Toyota Motor Corporation - Yoshiwara Plant',
        city: 'Toyota City',
        state: 'Aichi',
        country: 'Japan',
      },
      '7': {
        plantName: 'Toyota Motor Corporation - Fujimatsu Plant',
        city: 'Toyota City',
        state: 'Aichi',
        country: 'Japan',
      },
      '8': {
        plantName: 'Toyota Motor Corporation - Iwate Plant',
        city: 'Kanegasaki',
        state: 'Iwate',
        country: 'Japan',
      },
      '9': {
        plantName: 'Toyota Motor Corporation - Higashi Fuji Plant',
        city: 'Susono',
        state: 'Shizuoka',
        country: 'Japan',
      },
      A: {
        plantName: 'Toyota Motor Corporation - Toyota Auto Body',
        city: 'Kariya',
        state: 'Aichi',
        country: 'Japan',
      },
      B: {
        plantName: 'Toyota Motor Corporation - Kanto Auto Works',
        city: 'Yokkaichi',
        state: 'Mie',
        country: 'Japan',
      },
      ...
      // USA plants
      U: {
        plantName: 'Toyota Motor Manufacturing Kentucky (TMMK)',
        city: 'Georgetown',
        state: 'Kentucky',
        country: 'United States',
      },
      X: {
        plantName: 'Toyota Motor Manufacturing Indiana (TMMI)',
        city: 'Princeton',
        state: 'Indiana',
        country: 'United States',
      },
      Y: {
        plantName: 'Toyota Motor Manufacturing Texas (TMMTX)',
        city: 'San Antonio',
        state: 'Texas',
        country: 'United States',
      },
      Z: {
        plantName: 'Toyota Motor Manufacturing Mississippi (TMMMS)',
        city: 'Blue Springs',
        state: 'Mississippi',
        country: 'United States',
      },
      // UK
      G: {
        plantName: 'Toyota Motor Manufacturing UK (TMUK)',
        city: 'Burnaston',
        state: 'Derbyshire',
      ...
      // Turkey
      T: {
        plantName: 'Toyota Motor Manufacturing Turkey (TMMT)',
        city: 'Sakarya',
        country: 'Turkey',
      },
      // Thailand
      D: {
        plantName: 'Toyota Motor Thailand (TMT)',
        city: 'Chachoengsao',
        country: 'Thailand',
      },
      // China
      L: {
        plantName: 'GAC Toyota Motor',
        city: 'Guangzhou',
        state: 'Guangdong',
        country: 'China',
      },
      ...
      vehicles: [
        {
          ...
          model: 'C-HR',
          years: '2018-2022',
          engines: ['3ZR-FAE', '2ZR-FXE'],
        },
        {
          make: 'Toyota',
          model: 'Corolla',
          years: '2019-2024',
          engines: ['2ZR-FAE', 'M20A-FKS', 'M20A-FXS'],
        },
        {
          make: 'Toyota',
      ...
      vehicles: [
        {
          ...
          model: 'Camry',
          years: '2018-2024',
          engines: ['A25A-FKS', 'A25A-FXS', '2AR-FE'],
        },
        {
          make: 'Toyota',
          model: 'RAV4',
          years: '2019-2024',
          engines: ['A25A-FKS', 'A25A-FXS'],
        },
        {
          make: 'Toyota',
          model: 'Highlander',
          years: '2020-2024',
          engines: ['A25A-FKS', 'A25A-FXS', '2GR-FKS'],
        },
        {
          make: 'Lexus',
          model: 'ES',
      ...
      vehicles: [
        {
          ...
          model: 'LS',
          years: '2018-2024',
          engines: ['V35A-FTS', '8GR-FXS'],
        },
        {
          make: 'Lexus',
          model: 'LC',
          years: '2018-2024',
          engines: ['8GR-FXS', '2UR-GSE'],
        },
        {
          make: 'Toyota',
          model: 'Mirai',
