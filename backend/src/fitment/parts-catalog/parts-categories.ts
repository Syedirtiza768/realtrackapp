...
export const PARTS_CATEGORIES: PartsCategory[] = [
    ...
    subcategories: [
      {
        id: 'oil_filter',
        label: 'Oil Filter',
        requiresExactFitment: false,
        platformShareable: true,
        highDemand: true,
      },
      {
        id: 'spark_plugs',
      ...
      },
      {
        ...
        label: 'Air Filter',
        requiresExactFitment: false,
        platformShareable: false,
        highDemand: true,
      },
      {
        id: 'belts',
        label: 'Belts & Tensioners',
        requiresExactFitment: false,
        platformShareable: true,
        highDemand: false,
      },
      {
        id: 'gaskets',
        label: 'Gaskets & Seals',
        requiresExactFitment: true,
        platformShareable: true,
        highDemand: false,
      },
      {
        id: 'timing',
        label: 'Timing Chain/Belt Kit',
        requiresExactFitment: true,
        platformShareable: true,
        highDemand: true,
      },
  ...
  },
  {
    ...
    subcategories: [
      ...
      {
        id: 'bumper_reinforcement',
        label: 'Bumper Reinforcement',
        requiresExactFitment: true,
        platformShareable: false,
        highDemand: false,
      },
  ...
  },
  {
    ...
    subcategories: [
      ...
      {
        id: 'parking_brake_actuator',
        label: 'Parking Brake Actuator',
        requiresExactFitment: true,
        platformShareable: true,
        highDemand: false,
      },
...
export function getPlatformShareableCategories(): string[] {
  return PARTS_CATEGORIES.filter((cat) =>
    cat.subcategories.every((sub) => sub.platformShareable),
  ).map((cat) => cat.id);
}
...
export function getExactFitmentRequiredCategories(): string[] {
  return PARTS_CATEGORIES.filter((cat) =>
    cat.subcategories.some((sub) => sub.requiresExactFitment),
  ).map((cat) => cat.id);
}
...
export function getHighDemandCategories(): string[] {
  return PARTS_CATEGORIES.filter((cat) =>
    cat.subcategories.some((sub) => sub.highDemand),
  ).map((cat) => cat.id);
}
