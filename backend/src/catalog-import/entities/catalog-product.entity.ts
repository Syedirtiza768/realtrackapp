import type { ProductAttributes, ProductVertical } from '../../verticals/vertical.types.js';
import {
  Column,
  CreateDateColumn,
  Entity,
...
export class CatalogProduct {
  ...
  @Column({ name: 'vertical_validation_status', type: 'varchar', length: 24, default: 'draft' })
